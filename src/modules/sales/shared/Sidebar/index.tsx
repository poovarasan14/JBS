...
import Logo from "../../../cra-sales-template/images/logo/jbs logo.png"
...
>
  {(handleClick, open) => (
    <>
      ...
      <NavLink
        to="#"
        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-graydark hover:text-white dark:hover:bg-meta-4 ${
      ...
      >
        <ul className="mt-4 mb-4 flex flex-col gap-1 pl-6">
          {[
            "Sales",
            "Procurement",
            "Inventory",
                ...
                className={({ isActive }) =>
                  `group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out ${
                    isActive
                      ...
                      : "text-black hover:bg-graydark hover:text-white"
                  }`
                }
              >
                {item}
...
>
  {(handleClick, open) => (
    <>
      {/* Parent Link for Sales Module */}
      <NavLink
        to="#"
        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-graydark hover:text-white dark:hover:bg-meta-4 ${
          pathname.includes("sales") && "bg-graydark dark:bg-meta-4 text-white"
        }`}
        onClick={(e) => {
          e.preventDefault();
          sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black hover:text-white duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
