      ...
      <div className="space-y-2.5 border-t border-stroke p-4 dark:border-strokedark md:p-6 xl:p-7.5">
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            <img src={countryOne.src} alt="usa" />
        ...
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            <img src={countryTwo.src} alt="canada" />
        ...
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            <img src={countryThree.src} alt="france" />
        ...
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            <img src={countryFour.src} alt="italy" />
        ...
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            <img src={countryFive.src} alt="australia" />
        ...
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            <img src={countrySix.src} alt="india" />
