    ...
    <div>
      ...
      >
        <div
          ...
          className="md:px-17.5 relative w-full max-w-142.5 rounded-lg text-black bg-white px-8 py-12 text-center md:py-15"
        >
          ...
          <button
            onClick={() => setModalOpen(false)}
            className="absolute right-6 top-6 flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-black transition hover:bg-blue hover:text-primary"
          >
            <svg
              width="10"
              height="10"
