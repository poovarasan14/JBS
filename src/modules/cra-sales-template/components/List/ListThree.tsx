...
const listItems: ListItem[] = [
  { image: userOne.src, name: 'Devid Wilium', position: 'Digital marketer' },
  { image: userTwo.src, name: 'Deniyal Shifer', position: 'Graphics designer' },
  { image: userThree.src, name: 'Philifs Geno', position: 'Content creator' },
  { image: userFour.src, name: 'Marko Diyan', position: 'Web developer' },
];
